...
return new class extends Migration
{
    ...
    {
        // Remove 'reaction' from enum
        DB::statement("ALTER TABLE `whatsapp_messages` MODIFY COLUMN `message_type` ENUM('text', 'image', 'document', 'audio', 'video', 'location') DEFAULT 'text'");
    }
};
