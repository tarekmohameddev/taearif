                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="">{{ __('Content') }}</label>
                                                    ...
                                                    <textarea placeholder="Enter content" class="form-control" name="content" rows="3">{{ empty($data->content) ? '' : $data->content }}</textarea>
                                                <p id="errcontent" class="mt-2 mb-0 text-danger em"></p>
                                            </div>
                                        </div>
