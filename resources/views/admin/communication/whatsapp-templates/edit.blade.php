...
<div class="page-header">
    <h4 class="page-title">تعديل قالب واتس اب</h4>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">تعديل قالب واتس اب</div>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="2" 
                                          placeholder="وصف مختصر للقالب...">{{old('description', $whatsappTemplate->description)}}</textarea>
                                @error('description')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="6" 
                                          placeholder="أدخل محتوى القالب هنا..." required>{{old('content', $whatsappTemplate->content)}}</textarea>
                                <div class="mt-2">
                                    <small class="text-muted">
                                        عدد الأحرف: <span id="char-count">{{$whatsappTemplate->character_count}}</span> / 1600
                                    </small>
                                </div>
                                @error('content')
                                    <p class="text-danger">{{ $message }}</p>
                                ...
                                <div class="card-body">
                                    <div id="available-variables">
                                        @if($supportedVariables)
                                            ...
                                            @endforeach
                                        @else
                                            <p class="text-muted">اختر نوع القالب لعرض المتغيرات المتاحة</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
