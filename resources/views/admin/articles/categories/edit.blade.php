  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form id="ajaxForm" action="{{route('admin.articles.categories.update', $category->id)}}" method="POST">
            @csrf
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="description" name="description" rows="5" placeholder="{{__('Enter category description')}}">{{$category->description}}</textarea>
