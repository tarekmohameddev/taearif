...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{__('Edit Article')}}</h4>
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" name="title" value="{{$article->title}}" placeholder="{{__('Enter article title')}}" required>
                  <p id="errtitle" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="slug">{{__('Slug')}}</label>
                  <input type="text" class="form-control" id="slug" name="slug" value="{{$article->slug}}" placeholder="{{__('Auto-generated from title')}}">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="excerpt" name="excerpt" rows="3" placeholder="{{__('Brief description of the article')}}">{{$article->excerpt}}</textarea>
                  <p id="errexcerpt" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                  <label for="body">{{__('Body')}} **</label>
                  <textarea id="body" class="form-control summernote" name="body" data-height="500">{!! $article->body !!}</textarea>
              ...
              <div class="col-lg-4">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="status" name="status" required>
                    <option value="draft" {{$article->status->value == 'draft' ? 'selected' : ''}}>{{__('Draft')}}</option>
                    <option value="published" {{$article->status->value == 'published' ? 'selected' : ''}}>{{__('Published')}}</option>
                    <option value="scheduled" {{$article->status->value == 'scheduled' ? 'selected' : ''}}>{{__('Scheduled')}}</option>
                    <option value="archived" {{$article->status->value == 'archived' ? 'selected' : ''}}>{{__('Archived')}}</option>
                  </select>
                  <p id="errstatus" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group" id="published_at_group" style="{{$article->status->value == 'scheduled' ? 'display: block;' : 'display: none;'}}">
                ...
                <div class="form-group">
                  ...
                  @if($article->main_image)
                    <div id="main_image_preview" class="mt-2">
                      <img src="{{asset($article->main_image)}}" style="max-width: 200px; max-height: 200px;">
                    </div>
                  @else
                ...
                <div class="form-group">
                  ...
                  <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="cta_enabled" name="cta_enabled" value="1" {{$article->cta_enabled ? 'checked' : ''}}>
                    <label class="custom-control-label" for="cta_enabled">{{__('Enable CTA')}}</label>
                  </div>
                </div>
                <div id="cta_fields" style="{{$article->cta_enabled ? 'display: block;' : 'display: none;'}}">
                  <div class="form-group">
                    <label for="cta_text">{{__('CTA Text')}}</label>
                    <input type="text" class="form-control" id="cta_text" name="cta_text" value="{{$article->cta_text}}" placeholder="{{__('Call to action text')}}">
                    <p id="errcta_text" class="mb-0 text-danger em"></p>
                  </div>
                  <div class="form-group">
                    <label for="cta_url">{{__('CTA URL')}}</label>
                    <input type="url" class="form-control" id="cta_url" name="cta_url" value="{{$article->cta_url}}" placeholder="{{__('https://example.com')}}">
                    <p id="errcta_url" class="mb-0 text-danger em"></p>
                  </div>
                  <div class="form-group">
                    <div class="custom-control custom-switch">
                      <input type="checkbox" class="custom-control-input" id="cta_target_blank" name="cta_target_blank" value="1" {{$article->cta_target_blank ? 'checked' : ''}}>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{$article->meta_title}}" placeholder="{{__('SEO meta title')}}">
                ...
                <div class="form-group">
                  ...
                  @if($article->og_image)
                    <div id="og_image_preview" class="mt-2">
                      <img src="{{asset($article->og_image)}}" style="max-width: 200px; max-height: 200px;">
                    </div>
                  @else
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="{{__('SEO meta description')}}">{{$article->meta_description}}</textarea>
  ...
  <script>
    ...
    document.getElementById('title').addEventListener('input', function() {
      if (!document.getElementById('slug').value || document.getElementById('slug').value === '{{$article->slug}}') {
