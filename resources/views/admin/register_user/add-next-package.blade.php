                    ...
                    <div class="form-group">
                        ...
                        <select name="package_id" id="" class="form-control" required>
                            ...
                            @foreach ($packages as $package)
                                <option value="{{$package->id}}" {{!empty($nextPackage) && $nextPackage->id == $package->id ? 'selected' : ''}}>{{ $package->getDisplayTitle('ar') }}@unless($package->isTrialPackage()) ({{ __($package->term) }})@endunless</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
