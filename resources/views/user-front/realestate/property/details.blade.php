                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <figure class="radius-lg lazy-container ratio ratio-16-11">
                                    <a href="{{ asset($slider->image) }}" class="lightbox-single">
                ...
                <div class="product-single-details">
                        ...
                        <div class="col-md-5">
                            ...
                            <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 4px; direction: rtl;">
                                <span class="new-price" style="font-weight: 600; font-size: 1.0em;">
                                    ...
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/9/98/Saudi_Riyal_Symbol.svg" alt="Currency Symbol" style="width: 12px; height: 15px; vertical-align: middle;">
                            ...
                            <ul class="share-link list-unstyled mb-30">
                                <li class="d-none">
                                    <a class="btn blue" style="padding: 9px;" href="#" data-bs-toggle="modal" data-bs-target="#socialMediaModal">
                                ...
                                <li>
                                    @if(Auth::guard('api_customer')->check())
                                    <form action="{{ route('front.user.property.add-to-interested', [getParam(), 'id' => $propertyContent->propertyId]) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="submit" class="btn red" style="width: 100px !important; padding: 14px; height: 45px !important;" @if($interested) disabled @endif>
                                ...
                                <li>
                                    ...
                                    @endphp
                                    @endif
                                    <a href="{{ route('front.user.property.add-to-wishlist', [getParam(), 'id' => $propertyContent->propertyId]) }}" class="btn red d-none " data-tooltip="tooltip" data-bs-placement="top" title="{{ $checkWishList == false ? __('Add to Wishlist') : __('Saved') }}">
                    ...
                    <div class="product-video mb-40">
                        ...
                        <div class="lazy-container radius-lg ratio ratio-16-11">
                            ...
                            <a href="{{ $propertyContent->virtual_tour }}" class="video-btn youtube-popup p-absolute">
                    ...
                    <div class="product-planning mb-40">
                        ...
                        <div class="lazy-container radius-lg ratio ratio-16-11 border mb-3">
                            <img class="lazyload" src="{{ asset($image) }}" data-src="{{ asset($image) }}">
                        </div>
                        @endforeach
                    </div>
                    @endif
                    ...
                    <div class="product-location mb-40 d-none d-md-block">
