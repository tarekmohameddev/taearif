...
@section('content')
    ...
    @if (!is_null($heroStatic))
        <section class="home-banner home-banner-3 with-radius">
            <img class="lazyload bg-img blur-up" src="{{ asset('assets/front/img/hero_static/' . $heroStatic->img) }}"
                alt="Banner">
            <div class="container">
    ...
    @if ($home_sections->category_section == 1)
        <section class="category category-2 pb-100">
            ...
            <div class="shape">
                ...
                <img class="shape-5" src="{{ asset('assets/front/user/realestate/shape/shape-10.png') }}"
                    alt="Shape">
            </div>
        </section>
    @endif
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-15">
                                @if (!empty($home_text->about_button_url))
                                    <a href="{{ $home_text->about_button_url }}"
                                        class="btn btn-lg btn-primary">{{ $home_text?->about_button_text }}</a>
                                @endif
    ...
    @if ($home_sections->testimonials_section == 1)
        <section class="testimonial-area testimonial-3 pb-100">
            ...
            <div class="shape">
                <img class="shape-1" src="{{ asset('assets/front/user/realestate/shape/shape-10.png') }}"
                    alt="Shape">
                <img class="shape-2" src="{{ asset('assets/front/user/realestate/shape/shape-6.png') }}"
                    alt="Shape">
                <img class="shape-3" src="{{ asset('assets/front/user/realestate/shape/shape-3.png') }}"
                    alt="Shape">
                <img class="shape-4" src="{{ asset('assets/front/user/realestate/shape/shape-5.png') }}"
                    alt="Shape">
                <img class="shape-5" src="{{ asset('assets/front/user/realestate/shape/shape-2.png') }}"
                    alt="Shape">
            </div>
        </section>
    @endif
