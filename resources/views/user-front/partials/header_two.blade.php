                            ...
                            @if (in_array('Request a Quote', $packagePermissions))
                                @if ($userBs->is_quote)
                                    <li class="d-block d-lg-none"><a
                                            href="{{ route('front.user.quote', getParam()) }}">{{ $keywords['Request A Quote'] ?? 'Request A Quotes' }}</a>
                                    </li>
                                @endif
                            @endif
                        </ul>
                    ...
                    @if (in_array('Request a Quote', $packagePermissions))
                        @if ($userBs->is_quote)
                            <a href="{{ route('front.user.quote', getParam()) }}"
                                class="main-btn main-btn-3 d-none d-lg-inline-block">{{ $keywords['Request_A_Quote'] ?? 'Request A Quote' }}</a>
                        @endif
                    @endif
                    <!-- Navbar Toggler -->
