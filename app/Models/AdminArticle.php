...
class AdminArticle extends Model
{
    ...
    protected static function boot(): void
    {
        ...
        static::saving(function (AdminArticle $article): void {
            ...
            // Set published_at when status changes to published for first time
    ...
    {
        return $this->belongsTo(AdminArticleCategory::class, 'category_id');
    }
