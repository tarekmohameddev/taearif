...
class TestEvolutionWhatsApp extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'whatsapp:test-evolution {phone} {--all : Test all message types} {--welcome : Test welcome message} {--expiration : Test subscription expiration} {--expired : Test subscription expired} {--password : Test password reset}';
     ...
     * @var string
     */
    protected $description = 'Test WhatsApp messages using Evolution API';
    ...
    public function handle()
    {
        ...
        // Switch to Evolution API
        $settings = BasicSetting::first();
        $originalService = $settings->whatsapp_service;
        $settings->whatsapp_service = 'evolution_api';
        $settings->save();
        
        $this->info("🚀 Testing WhatsApp messages with Evolution API for phone: {$phone}");
        $this->info("📱 Switched to Evolution API");
