...
trait NormalizesDistrictLocation
{
    protected function prepareDistrictForValidation(): void
    {
    ...
    protected function districtLocationRules(bool $districtRequired = true): array
    {
    ...
    protected function validateDistrictCityMatch(Validator $validator): void
    {
