...
class CollectPaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payments.*.payment_type' => ['required', RmsConstants::validationRule(RmsConstants::PAYMENT_TYPES)],
    ...
    {
        return [
            'payments.required' => 'Please provide at least one payment.',
            'payments.array' => 'Payments must be provided as an array.',
            'payments.min' => 'At least one payment is required.',
            'payments.*.installment_id.required' => 'Each payment must have an installment ID.',
            'payments.*.installment_id.exists' => 'The selected installment does not exist.',
            'payments.*.payment_type.required' => 'Please specify the payment type.',
    ...
    public function withValidator($validator)
    {
        ...
        $validator->after(function ($validator) use ($paymentMethod, $bankName) {
