    ...
    public function update(PropertyUpdateRequest $request, $id)
    {
        DB::transaction(function () use ($request, $id) {
            ...
            foreach ($languages as $language) {
                ...
                // Slug will be auto-generated by Attribute setter, but ensure uniqueness
                if ($request->input($language->code . '_title')) {
                    $propertyContent->slug = PropertyContent::generateUniqueSlug(
