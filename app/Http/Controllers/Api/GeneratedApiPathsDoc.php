 ...
 *         tags={"Rms"},
 *         summary="Store", security={{"sanctum":{}}},
 *         description="Accepts base_rent_amount or total_rental_amount (either required; total wins if both). Ship with installment schedule Phase 1+2 together.",
 ...
 *             @OA\Property(property="base_rent_amount", type="number", description="Per-payment amount; required without total_rental_amount"),
 *             @OA\Property(property="total_rental_amount", type="number", description="Full-term total; required without base_rent_amount; wins if both sent"),
 *             @OA\Property(property="currency", type="string"),
 ...
 *         tags={"Rms"},
 *         summary="Update", security={{"sanctum":{}}},
 *         description="PATCH-only. Accepts base_rent_amount; total wins if both amounts sent. Auto-regenerates unpaid installments when amount/plan/duration/type/move-in change (or regenerate_schedule=true). Mid-lease total_rental_amount is a notional rate base; stored total folds invoiced survivors + new rate for remaining. payments is legacy/discouraged and cannot combine with schedule-affecting fields. Deploy with installment Phase 1+2 together.",
 *         @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer")),
 *         @OA\RequestBody(required=true, @OA\JsonContent(type="object", required={},
 *             @OA\Property(property="tenant_full_name", type="string", maxLength=150),
 *             @OA\Property(property="tenant_phone", type="string", maxLength=32),
 ...
 *             @OA\Property(property="rental_duration", type="integer", minimum=1),
 *             @OA\Property(property="paying_plan", type="string", enum={"monthly","quarterly","semi_annual","annual"}),
 *             @OA\Property(property="base_rent_amount", type="number", description="Going-forward per-payment amount"),
 *             @OA\Property(property="total_rental_amount", type="number", description="Notional full-term rate base mid-lease; total wins if both amounts sent"),
 *             @OA\Property(property="currency", type="string"),
 *             @OA\Property(property="contract_number", type="string", maxLength=255),
 *             @OA\Property(property="notes", type="string"),
 *             @OA\Property(property="cost_items", type="object", properties={@OA\Property(property="*.name", type="string", maxLength=255),@OA\Property(property="*.cost", type="number", minimum=0),@OA\Property(property="*.type", type="string", enum={"fixed","percentage"}),@OA\Property(property="*.payer", type="string", enum={"owner","tenant"}),@OA\Property(property="*.payment_frequency", type="string", enum={"one_time","per_installment"}),@OA\Property(property="*.percentage_of", type="number", minimum=0),@OA\Property(property="*.description", type="string")}),
